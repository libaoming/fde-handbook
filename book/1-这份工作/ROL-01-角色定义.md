...
Palantir 在官方博客里把自家工程师切成两类，并把差别压缩成一句话：
Dev 是一个能力服务许多客户，Delta 是一家客户身上横跨许多能力
（引证见节末 Palantir "Dev versus Delta" 框）。FDE 就是后一种工程师——
这个角色的定义、职责与边界，都从这条分界长出来。
...
- **附录 A · FX-ORG-04**——症状「什么都找你，角色被当成驻场咨询/售后」的速查入口
